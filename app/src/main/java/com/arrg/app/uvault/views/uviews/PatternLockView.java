...
public class PatternLockView extends View {
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        mRegularColor = typedArray.getColor(R.styleable.PatternLockView_lock_color, Color.WHITE);
        mErrorColor = typedArray.getColor(R.styleable.PatternLockView_wrong_color, Color.RED);
        mSuccessColor = typedArray.getColor(R.styleable.PatternLockView_correct_color, Color.GREEN);
        typedArray.recycle();
    ...
    public void setmRegularColor(int mRegularColor) {
        this.mRegularColor = mRegularColor;
    }
